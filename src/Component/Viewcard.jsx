...
const Viewcard = () => {
    ...
    return (
        ...
        <div className="w-[350px] md:w-[400px] lg:w-[1200px] mx-auto">
          ...
          <section>
	<div className="bg-green-950 md:mx-auto">
		<div className="container flex flex-col items-center px-4 py-16 pb-24 mx-auto text-center lg:pb-56 md:py-32 md:px-10 lg:px-32 text-gray-900 md:mx-auto">
...
<div className="w-[350px] md:w-[400px] lg:w-[1100px] mx-auto md:mx-auto">
