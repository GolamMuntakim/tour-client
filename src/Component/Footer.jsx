...
const Footer = () => {
    return (
        <div>
            <footer className="px-4 divide-y bg-gray-800 text-gray-100 w-[350px] lg:w-[1200px]  mx-auto rounded-lg mt-8">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				...
				<span className="self-center text-2xl font-semibold">Traveler'<span className="text-red-500">s</span></span>
			</a>
		</div>
